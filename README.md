...
*   `context` **[Object](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)?** Context to bind method when invoking.
*   `once` **[boolean](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean)** Register handler as one-time handler, i.e. the handler is automatically unregistered once invoked. (optional, default `false`)
